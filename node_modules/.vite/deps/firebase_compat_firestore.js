      ...
      a: {
        ...
        if (!(3 > r) && (r != 3 || ya || this.g && (this.h.h || this.g.fa() || hc(this.g)))) {
          ...
          if (this.i) {
            ...
            this.P ? (lc(this, r, h), ya && this.i && r == 3 && (Eb(this.S, this.T, "tick", this.gb), this.T.start())) : (E(this.j, this.m, h, null), kc(this, h));
            r == 4 && P(this);
...
k.fb = function() {
  this.B = null;
  const a = Date.now();
  0 <= a - this.V ? (Kb(this.j, this.A), this.K != 2 && (H(3), I(17)), P(this), this.o = 2, Q(this)) : pc(this, this.V - a);
};
function Q(a) {
      ...
      if (!a.J && qc(c.h, a) && c.G == 3) {
        ...
        if (Array.isArray(d) && d.length == 3) {
          ...
          if (e[0] == 0)
            ...
            c.Ba = e[1], 0 < c.Ba - c.T && 37500 > e[2] && c.L && c.A == 0 && !c.v && (c.v = J(q(c.bb, c), 6e3));
          if (1 >= uc(c.h) && c.ja) {
            try {
              c.ja();
            } catch (m) {
          ...
          if (c.G == 2)
            if (m[0] == "c") {
              ...
              if (Z2) {
                ...
                if (Da2) {
                  var f = d.h;
                  f.g || Da2.indexOf("spdy") == -1 && Da2.indexOf("quic") == -1 && Da2.indexOf("h2") == -1 || (f.j = f.l, f.g = /* @__PURE__ */ new Set(), f.h && (vc(f, f.h), f.h = null));
                }
                if (d.D) {
...
function Wc(a) {
  this.l = a || Xc;
  l.PerformanceNavigationTiming ? (a = l.performance.getEntriesByType("navigation"), a = 0 < a.length && (a[0].nextHopProtocol == "hq" || a[0].nextHopProtocol == "h2")) : a = !!(l.g && l.g.Ga && l.g.Ga() && l.g.Ga().Zb);
  this.j = a ? this.l : 1;
  this.g = null;
...
function Bd(a, b2) {
  ...
  if (a.G == 1 || a.G == 2 || a.C >= (a.Ya ? 0 : a.Za))
    return false;
...
var G2 = class {
  ...
  getToken() {
    ...
    return this.forceRefresh = false, this.auth ? this.auth.getToken(e).then((e2) => this.i !== t2 ? (D2("FirebaseAuthCredentialsProvider", "getToken aborted due to token change."), this.getToken()) : e2 ? (M2(typeof e2.accessToken == "string"), new U2(e2.accessToken, this.currentUser)) : null) : Promise.resolve(null);
  }
  invalidateToken() {
  ...
  u() {
    ...
    return M2(t2 === null || typeof t2 == "string"), new b(t2);
  }
};
var Q2 = class {
...
var z2 = class {
  ...
  start(t2, e) {
    const n = (t3) => {
      t3.error != null && D2("FirebaseAppCheckTokenProvider", `Error getting App Check token; using placeholder token instead. Error: ${t3.error.message}`);
  ...
  getToken() {
    ...
    return this.forceRefresh = false, this.appCheck ? this.appCheck.getToken(t2).then((t3) => t3 ? (M2(typeof t3.token == "string"), this.A = t3.token, new W2(t3.token)) : null) : Promise.resolve(null);
  }
  invalidateToken() {
    this.forceRefresh = true;
  }
...
var st = class {
  constructor(t2, e, n) {
    e === void 0 ? e = 0 : e > t2.length && k2(), n === void 0 ? n = t2.length - e : n > t2.length - e && k2(), this.segments = t2, this.offset = e, this.len = n;
  }
  get length() {
    return this.len;
  }
  isEqual(t2) {
    return st.comparator(this, t2) === 0;
  }
  child(t2) {
...
var ut = class {
  ...
  isEqual(t2) {
    return t2 !== null && it.comparator(this.path, t2.path) === 0;
  }
  toString() {
...
function wt(t2, e) {
  const n = t2.toTimestamp().seconds, s = t2.toTimestamp().nanoseconds + 1, i = nt.fromTimestamp(s === 1e9 ? new et(n + 1, 0) : new et(n, s));
...
function yt(t2, e) {
  ...
  return n !== 0 ? n : (n = ut.comparator(t2.documentKey, e.documentKey), n !== 0 ? n : X2(t2.largestBatchId, e.largestBatchId));
}
...
var Rt = class {
  constructor(t2, e, n) {
    ...
    Rt.D(getUA()) === 12.2 && C2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
  static delete(t2) {
  ...
  static N() {
    var t2;
    return typeof process != "undefined" && ((t2 = process.env) === null || t2 === void 0 ? void 0 : t2.M) === "YES";
  }
  static O(t2, e) {
    return t2.store(e);
  }
  ...
  async F(t2) {
    return this.db || (D2("SimpleDb", "Opening database:", this.name), this.db = await new Promise((e, n) => {
      ...
      s.onsuccess = (t3) => {
        ...
        s2.name === "VersionError" ? n(new B2($.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : s2.name === "InvalidStateError" ? n(new B2($.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s2)) : n(new Pt(t2, s2));
...
var Vt = class {
  ...
  put(t2, e) {
    let n;
    return e !== void 0 ? (D2("SimpleDb", "PUT", this.store.name, t2, e), n = this.store.put(e, t2)) : (D2("SimpleDb", "PUT", this.store.name, "<auto-key>", t2), n = this.store.put(t2)), St(n);
  }
  add(t2) {
  ...
  get(t2) {
    return St(this.store.get(t2)).next((e) => (e === void 0 && (e = null), D2("SimpleDb", "GET", this.store.name, t2, e), e));
  }
  delete(t2) {
...
var Nt = class {
  ...
  it(t2, e) {
    ...
    let s = e, i = true;
    return Et.doWhile(() => i === true && s > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(t2).next((e2) => {
      if (e2 !== null && !n.has(e2))
...
var Lt = class {
  constructor(t2, e, n, s, i) {
    this.key = t2, this.value = e, this.color = n != null ? n : Lt.RED, this.left = s != null ? s : Lt.EMPTY, this.right = i != null ? i : Lt.EMPTY, this.size = this.left.size + 1 + this.right.size;
  }
  copy(t2, e, n, s, i) {
    return new Lt(t2 != null ? t2 : this.key, e != null ? e : this.value, n != null ? n : this.color, s != null ? s : this.left, i != null ? i : this.right);
  }
  isEmpty() {
    return false;
  }
...
function ie(t2) {
  return typeof t2 == "number" && Number.isInteger(t2) && !se(t2) && t2 <= Number.MAX_SAFE_INTEGER && t2 >= Number.MIN_SAFE_INTEGER;
}
var re = {
  mapValue: {
    fields: {
    ...
    case 10:
      return function(t3, e2) {
        ...
        if (Mt(n2) !== Mt(s))
          return false;
        for (const t4 in n2)
          if (n2.hasOwnProperty(t4) && (s[t4] === void 0 || !ce(n2[t4], s[t4])))
            return false;
        return true;
      }(t2, e);
    default:
...
function ae(t2, e) {
  return (t2.values || []).find((t3) => ce(t3, e)) !== void 0;
}
function he(t2, e) {
  if (t2 === e)
    return 0;
...
function le(t2, e) {
  ...
  return i !== 0 ? i : X2(n.nanos, s.nanos);
}
function fe(t2) {
  return de(t2);
}
...
function ke(t2) {
  return ut.isDocumentKey(t2.path) && t2.collectionGroup === null && t2.filters.length === 0;
}
function Me(t2, e) {
...
var $e = class extends class {
  ...
  static create(t2, e, n) {
    return t2.isKeyField() ? e === "in" || e === "not-in" ? this.lt(t2, e, n) : new Be(t2, e, n) : e === "array-contains" ? new Ke(t2, n) : e === "in" ? new Ge(t2, n) : e === "not-in" ? new Qe(t2, n) : e === "array-contains-any" ? new je(t2, n) : new $e(t2, e, n);
  }
  static lt(t2, e, n) {
    return e === "in" ? new Le(t2, n) : new Ue(t2, n);
  }
  matches(t2) {
    const e = t2.data.field(this.field);
    return this.op === "!=" ? e !== null && this.ft(he(e, this.value)) : e !== null && ue(this.value) === ue(e) && this.ft(he(e, this.value));
  }
  ft(t2) {
    switch (this.op) {
      case "<":
...
function qe(t2, e) {
  var n;
  return (((n = e.arrayValue) === null || n === void 0 ? void 0 : n.values) || []).map((t3) => ut.fromName(t3.referenceValue));
}
...
var Ge = class extends $e {
  ...
  matches(t2) {
    const e = t2.data.field(this.field);
    return e !== null && ae(this.value.arrayValue, e);
  }
};
...
function fn(t2, e) {
  return e.isFoundDocument() && function(t3, e2) {
    const n = e2.key.path;
    return t3.collectionGroup !== null ? e2.key.hasCollectionId(t3.collectionGroup) && t3.path.isPrefixOf(n) : ut.isDocumentKey(t3.path) ? t3.path.isEqual(n) : t3.path.isImmediateParentOf(n);
  }(t2, e) && function(t3, e2) {
...
function wn(t2, e, n) {
  const s = t2.field.isKeyField() ? ut.comparator(e.key, n.key) : function(t3, e2, n2) {
    ...
    return s2 !== null && i !== null ? he(s2, i) : k2();
  }(t2.field, e, n);
  switch (t2.dir) {
    case "asc":
      return s;
...
function Bn(t2, e, n, s) {
  return t2 instanceof qn ? function(t3, e2, n2, s2) {
    ...
    if (r.setAll(Gn(t3)), r.setAll(i), e2.convertToFoundDocument(e2.version, r).setHasLocalMutations(), n2 === null)
      return null;
...
function Ln(t2, e) {
  ...
  for (const s of t2.fieldTransforms) {
    ...
    i != null && (n === null && (n = Pe.empty()), n.set(s.field, i));
  }
  return n || null;
}
function Un(t2, e) {
  return t2.type === e.type && (!!t2.key.isEqual(e.key) && (!!t2.precondition.isEqual(e.precondition) && (!!function(t3, e2) {
    return t3 === void 0 && e2 === void 0 || !(!t3 || !e2) && Z(t3, e2, (t4, e3) => xn(t4, e3));
    ...
    this.Lt.forEach((n2, s2) => {
      ...
      if (i) {
        if (n2.current && ke(i.target)) {
          ...
          this.Ut.get(e2) !== null || this.ee(s2, e2) || this.jt(s2, e2, Ve.newNoDocument(e2, t2));
        }
...
function Ms(t2) {
  const e = Cs(t2);
  return e.length === 4 ? it.emptyPath() : Fs(e);
}
function Os(t2) {
...
function Us(t2, e) {
  ...
  if ("targetChange" in e) {
    e.targetChange;
    const s = function(t3) {
      return t3 === "NO_CHANGE" ? 0 : t3 === "ADD" ? 1 : t3 === "REMOVE" ? 2 : t3 === "CURRENT" ? 3 : t3 === "RESET" ? 4 : k2();
    }(e.targetChange.targetChangeType || "NO_CHANGE"), i = e.targetChange.targetIds || [], r = function(t3, e2) {
      return t3.gt ? (M2(e2 === void 0 || typeof e2 == "string"), jt.fromBase64String(e2 || "")) : (M2(e2 === void 0 || e2 instanceof Uint8Array), jt.fromUint8Array(e2 || new Uint8Array()));
    }(t2, e.targetChange.resumeToken), o = e.targetChange.cause, u = o && function(t3) {
      const e2 = t3.code === void 0 ? $.UNKNOWN : Zn(t3.code);
...
function Ks(t2, e) {
  const n = e.currentDocument ? function(t3) {
    return t3.updateTime !== void 0 ? kn.updateTime(Ss(t3.updateTime)) : t3.exists !== void 0 ? kn.exists(t3.exists) : kn.none();
  }(e.currentDocument) : kn.none(), s = e.updateTransforms ? e.updateTransforms.map((e2) => function(t3, e3) {
    let n2 = null;
    if ("setToServerValue" in e3)
      M2(e3.setToServerValue === "REQUEST_TIME"), n2 = new An();
...
function js(t2, e) {
  ...
  e.collectionGroup !== null ? (n.parent = ks(t2, s), n.structuredQuery.from = [{
...
function Ws(t2) {
  ...
  n.orderBy && (o = n.orderBy.map((t3) => function(t4) {
    return new ze(Zs(t4.field), function(t5) {
      switch (t5) {
        case "ASCENDING":
          return "asc";
        case "DESCENDING":
  ...
  n.limit && (u = function(t3) {
    let e2;
    return e2 = typeof t3 == "object" ? t3.value : t3, ne(e2) ? null : e2;
  }(n.limit));
  let c = null;
...
function Hs(t2) {
  return t2 ? t2.unaryFilter !== void 0 ? [ei(t2)] : t2.fieldFilter !== void 0 ? [ti(t2)] : t2.compositeFilter !== void 0 ? t2.compositeFilter.filters.map((t3) => Hs(t3)).reduce((t3, e) => t3.concat(e)) : k2() : [];
}
function Js(t2) {
  return As[t2];
}
...
var Ni = class {
  ...
  applyToLocalDocumentSet(t2, e) {
    ...
    return this.mutations.forEach((s) => {
      ...
      const u = Fn(r, o);
      u !== null && n.set(s.key, u), r.isValidDocument() || r.convertToNoDocument(nt.min());
    }), n;
  }
  keys() {
...
function Gi(t2) {
  const e = qi(t2.readTime), n = t2.lastLimboFreeSnapshotVersion !== void 0 ? qi(t2.lastLimboFreeSnapshotVersion) : nt.min();
  let s;
  var i;
  return t2.query.documents !== void 0 ? (M2((i = t2.query).documents.length === 1), s = un(tn(Ms(i.documents[0])))) : s = function(t3) {
    return un(Ws(t3));
...
function ji(t2) {
  ...
  return t2.limitType === "LAST" ? cn(e, e.limit, "L") : e;
}
function Wi(t2, e) {
...
var Zi = class {
  ...
  getOverlaysForCollection(t2, e, n) {
    const s = os(), i = ii(e), r = IDBKeyRange.bound([this.userId, i, n], [this.userId, i, Number.POSITIVE_INFINITY], true);
...
var ir = class {
  ...
  Ae(t2) {
    const e = 255 & t2;
    e === 0 ? (this.Me(0), this.Me(255)) : e === 255 ? (this.Me(255), this.Me(0)) : this.Me(e);
  }
  Pe(t2) {
    const e = 255 & t2;
...
function ar(t2, e) {
  ...
  return n !== 0 ? n : (n = hr(t2.arrayValue, e.arrayValue), n !== 0 ? n : (n = hr(t2.directionalValue, e.directionalValue), n !== 0 ? n : ut.comparator(t2.documentKey, e.documentKey)));
}
function hr(t2, e) {
...
var wr = class {
  ...
  getCollectionParents(t2, e) {
    const n = [], s = IDBKeyRange.bound([e, ""], [tt(e), ""], false, true);
        ...
        return Et.forEach(i, (i2, r) => {
          ...
          const u = function(t4, e2) {
            ...
            for (const i3 of ht(e2)) {
              const e3 = i3.kind === 0 ? Oe(t4, i3.fieldPath, t4.startAt) : Fe(t4, i3.fieldPath, t4.startAt);
            ...
            let s3 = true;
            for (const i3 of ht(e2)) {
              const e3 = i3.kind === 0 ? Fe(t4, i3.fieldPath, t4.endAt) : Oe(t4, i3.fieldPath, t4.endAt);
              n2.push(e3.value), s3 && (s3 = e3.inclusive);
            }
            return new We(n2, s3);
  ...
  rn(t2, e, n, s, i, r, o) {
    ...
    for (let h = 0; h < u; ++h) {
      const u2 = e ? this.on(e[h / c]) : _r, l2 = this.un(t2, u2, n[h % c], s), f = this.cn(t2, u2, i[h % c], r), d = o.map((e2) => this.un(t2, u2, e2, true));
  ...
  en(t2, e) {
    const n = new lr(e), s = e.collectionGroup != null ? e.collectionGroup : e.path.lastSegment();
  ...
  ln(t2, e) {
    return !!t2.filters.find((t3) => t3 instanceof $e && t3.field.isEqual(e) && (t3.op === "in" || t3.op === "not-in"));
  }
  getFieldIndexes(t2, e) {
  ...
  getNextCollectionGroupToUpdate(t2) {
    return this.getFieldIndexes(t2).next((t3) => t3.length === 0 ? null : (t3.sort((t4, e) => {
      ...
      return n !== 0 ? n : X2(t4.collectionGroup, e.collectionGroup);
  ...
  createRange(t2, e, n) {
    n = n.sort((t3, e2) => ar(t3, e2)).filter((t3, e2, n2) => !e2 || ar(t3, n2[e2 - 1]) !== 0);
    const s = [];
    s.push(t2);
    for (const i2 of n) {
...
var Cr = class {
  ...
  Vn(t2) {
    return Nr(t2).get("targetGlobalKey").next((t3) => (M2(t3 !== null), t3));
  }
  Sn(t2, e) {
  ...
  removeMatchingKeysForTargetId(t2, e) {
    const n = kr(t2), s = IDBKeyRange.bound([e], [e + 1], false, true);
    return n.delete(s);
  }
  getMatchingKeysForTargetId(t2, e) {
    const n = IDBKeyRange.bound([e], [e + 1], false, true), s = kr(t2);
    let i = ls();
    return s.Z({
      range: n,
      X: true
  ...
  containsKey(t2, e) {
    const n = ii(e.path), s = IDBKeyRange.bound([n], [tt(n)], false, true);
    let i = 0;
    return kr(t2).Z({
...
var Br = class {
  ...
  Kn(t2, e) {
    ...
    return n.Z({
      ...
      t3 === 0 ? (i !== kt.at && e(new ut(ui(s)), i), i = o, s = r) : i = kt.at;
    }).next(() => {
...
function Lr(t2, e) {
  return kr(t2).put(function(t3, e2) {
    return {
      targetId: 0,
      path: ii(t3.path),
      sequenceNumber: e2
...
var Ur = class {
  ...
  getEntry(t2, e) {
    ...
    return n !== void 0 ? Et.resolve(n) : this.getFromCache(t2, e);
  }
  getEntries(t2, e) {
...
var Yr = class {
  ...
  getDocument(t2, e) {
    let n = null;
    return this.documentOverlayCache.getOverlay(t2, e).next((s) => (n = s, this.getBaseDocument(t2, e, n))).next((t3) => (n !== null && Bn(n.mutation, t3, Gt.empty(), et.now()), t3));
  }
  getDocuments(t2, e) {
  ...
  computeViews(t2, e, n, s) {
    ...
    return e.forEach((t3, e2) => {
      ...
      s.has(e2.key) && (o2 === void 0 || o2.mutation instanceof Kn) ? i = i.insert(e2.key, e2) : o2 !== void 0 && (r.set(e2.key, o2.mutation.getFieldMask()), Bn(o2.mutation, e2, o2.mutation.getFieldMask(), et.now()));
    }), this.recalculateAndSaveOverlays(t2, i).next((t3) => (t3.forEach((t4, e2) => r.set(t4, e2)), e.forEach((t4, e2) => {
      var n2;
      return o.set(t4, new Jr(e2, (n2 = r.get(t4)) !== null && n2 !== void 0 ? n2 : null));
    }), o));
  }
  ...
  getDocumentsMatchingQuery(t2, e, n) {
    return function(t3) {
      return ut.isDocumentKey(t3.path) && t3.collectionGroup === null && t3.filters.length === 0;
  ...
  getDocumentsMatchingCollectionGroupQuery(t2, e, n) {
    ...
    return this.indexManager.getCollectionParents(t2, s).next((r) => Et.forEach(r, (r2) => {
      const o = function(t3, e2) {
        return new Xe(e2, null, t3.explicitOrderBy.slice(), t3.filters.slice(), t3.limit, t3.limitType, t3.startAt, t3.endAt);
      }(e, r2.child(s));
  ...
  getDocumentsMatchingCollectionQuery(t2, e, n) {
    ...
    return this.remoteDocumentCache.getAllFromCollection(t2, e.path, n).next((i) => (s = i, this.documentOverlayCache.getOverlaysForCollection(t2, e.path, n.largestBatchId))).next((t3) => {
      t3.forEach((t4, e2) => {
        const n3 = e2.getKey();
        s.get(n3) === null && (s = s.insert(n3, Ve.newInvalidDocument(n3)));
      });
      let n2 = is();
      return s.forEach((s2, i) => {
        const r = t3.get(s2);
        r !== void 0 && Bn(r.mutation, i, Gt.empty(), et.now()), fn(e, i) && (n2 = n2.insert(s2, i));
      }), n2;
    });
  }
  getBaseDocument(t2, e, n) {
    return n === null || n.mutation.type === 1 ? this.remoteDocumentCache.getEntry(t2, e) : Et.resolve(Ve.newInvalidDocument(e));
  }
};
var Xr = class {
  constructor(t2) {
...
var Zr = class {
  ...
  removeOverlaysForBatchId(t2, e, n) {
    ...
    return s !== void 0 && (s.forEach((t3) => this.overlays = this.overlays.remove(t3)), this.es.delete(n)), Et.resolve();
  }
  getOverlaysForCollection(t2, e, n) {
  ...
  getOverlaysForCollectionGroup(t2, e, n, s) {
    ...
    for (; r.hasNext(); ) {
      ...
      if (t3.getKey().getCollectionGroup() === e && t3.largestBatchId > n) {
        ...
        e2 === null && (e2 = os(), i = i.insert(t3.largestBatchId, e2)), e2.set(t3.getKey(), t3);
      }
    }
  ...
  ue(t2, e, n) {
    ...
    let i = this.es.get(e);
    i === void 0 && (i = ls(), this.es.set(e, i)), this.es.set(e, i.add(n.key));
  }
};
var to = class {
  constructor() {
...
var no = class {
  ...
  checkEmpty(t2) {
    return Et.resolve(this.mutationQueue.length === 0);
  }
  addMutationBatch(t2, e, n, s) {
    const i = this.ws;
  ...
  getHighestUnacknowledgedBatchId() {
    return Et.resolve(this.mutationQueue.length === 0 ? -1 : this.ws - 1);
  }
  getAllMutationBatches(t2) {
  ...
  zs(t2, e) {
    ...
    return n.W().next((t3) => {
      ...
      return t3.forEach((t4) => {
        var e2;
        let s2 = (e2 = n2.get(t4.userId)) !== null && e2 !== void 0 ? e2 : ls();
...
var fo = class {
  ...
  di(t2) {
    ...
    return _o(t2).get("owner").next((e) => {
      ...
      return !(!this.networkEnabled || !this.inForeground) || wo(t2).W().next((t3) => this.Ii(t3, 5e3).find((t4) => {
  ...
  runTransaction(t2, e, n) {
    ...
    const s = e === "readonly" ? "readonly" : "readwrite", i = (r = this.Xs) === 15 ? Di : r === 14 ? Si : r === 13 ? Vi : r === 12 ? vi : r === 11 ? Pi : void k2();
    var r;
    let o;
    return this.ri.runTransaction(t2, s, i, (s2) => (o = new Ci(s2, this.Ss ? this.Ss.next() : kt.at), e === "readwrite-primary" ? this.fi(o).next((t3) => !!t3 || this.di(o)).next((e2) => {
      if (!e2)
...
var yo = class {
  ...
  ki(t2, e) {
    if (en(e))
      return Et.resolve(null);
    let n = un(e);
    return this.indexManager.getIndexType(t2, n).next((s) => s === 0 ? null : (e.limit !== null && s === 1 && (e = cn(e, null, "F"), n = un(e)), this.indexManager.getDocumentsMatchingTarget(t2, n).next((s2) => {
      const i = ls(...s2);
...
function So(t2, e, n) {
  ...
  return s.persistence.runTransaction("Execute query", "readonly", (t3) => function(t4, e2, n2) {
    ...
    return i2 !== void 0 ? Et.resolve(s2.Ui.get(i2)) : s2.Cs.getTargetData(e2, n2);
  }(s, t3, un(e)).next((e2) => {
    if (e2)
...
function Co(t2, e) {
  ...
  return n.persistence.runTransaction("Get new document changes", "readonly", (t3) => n.Gi.getAllFromCollectionGroup(t3, e, wt(s, -1), Number.MAX_SAFE_INTEGER)).then((t3) => (xo(n, e, t3), t3));
}
function xo(t2, e, n) {
  let s = nt.min();
  n.forEach((t3, e2) => {
...
var $o = class {
  ...
  static Zi(t2, e, n) {
    ...
    return r && s.error && (r = typeof s.error.message == "string" && typeof s.error.code == "string", r && (i = new B2(s.error.code, s.error.message))), r ? new $o(t2, e, s.state, i) : (C2("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), null);
  }
  tr() {
    const t2 = {
      state: this.state,
...
var Bo = class {
  ...
  static Zi(t2, e) {
    ...
    return i && n.error && (i = typeof n.error.message == "string" && typeof n.error.code == "string", i && (s = new B2(n.error.code, n.error.message))), i ? new Bo(t2, n.state, s) : (C2("SharedClientState", `Failed to parse target state for ID '${t2}': ${e}`), null);
  }
  tr() {
    const t2 = {
      state: this.state,
...
var Lo = class {
  ...
  static Zi(t2, e) {
    const n = JSON.parse(e);
    let s = typeof n == "object" && n.activeTargetIds instanceof Array, i = ds();
...
var Uo = class {
  ...
  static Zi(t2) {
    ...
    return typeof e == "object" && ["Unknown", "Online", "Offline"].indexOf(e.onlineState) !== -1 && typeof e.clientId == "string" ? new Uo(e.clientId, e.onlineState) : (C2("SharedClientState", `Failed to parse online state: ${t2}`), null);
  }
};
var qo = class {
  constructor() {
    ...
    return f(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (i2) {
          ...
          e3 === void 0 && (e3 = $.INTERNAL, n3 = "Unknown error status: " + t4 + " with message " + i2.message), h = true, l2.io(new B2(e3, n3)), c.close();
        } else
...
var tu = class {
  ...
  Fo() {
    this.ko() && this.Do === null && (this.Do = this.Hs.enqueueAfterDelay(this.Po, 6e4, () => this.$o()));
  }
  Bo(t2) {
  ...
  async close(t2, e) {
    this.Lo(), this.Uo(), this.xo.cancel(), this.So++, t2 !== 4 ? this.xo.reset() : e && e.code === $.RESOURCE_EXHAUSTED ? (C2(e.toString()), C2("Using maximum backoff delay to prevent overloading the backend."), this.xo.Eo()) : e && e.code === $.UNAUTHENTICATED && this.state !== 3 && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()), this.stream !== null && (this.qo(), this.stream.close(), this.stream = null), this.state = t2, await this.listener.Zr(e);
  }
  qo() {
  }
  auth() {
...
var su = class extends class {
  ...
  co(t2, e, n) {
    return this.su(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([s, i]) => this.Vo.co(t2, e, n, s, i)).catch((t3) => {
      throw t3.name === "FirebaseError" ? (t3.code === $.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t3) : new B2($.UNKNOWN, t3.toString());
    });
  }
  fo(t2, e, n, s) {
...
function au(t2, e) {
  const n = F(t2), s = xu(n);
  n.du.delete(e), s.ko() && lu(n, e), n.du.size === 0 && (s.ko() ? s.Fo() : _u(n) && n.gu.set("Unknown"));
}
function hu(t2, e) {
...
async function yu(t2, e, n) {
  if (t2.gu.set("Online"), e instanceof ys && e.state === 2 && e.cause)
    try {
...
var ku = class {
  ...
  cancel(t2) {
    this.timerHandle !== null && (this.clearTimeout(), this.deferred.reject(new B2($.CANCELLED, "Operation cancelled" + (t2 ? ": " + t2 : ""))));
  }
  handleDelayElapsed() {
...
var $u = class {
  ...
  static fromInitialDocuments(t2, e, n, s) {
    ...
    }), new $u(t2, e, Ou.emptySet(e), i, n, s, true, false);
  }
  get hasPendingWrites() {
...
var ju = class {
  ...
  Pu(t2) {
    if (!this.options.includeMetadataChanges) {
      ...
      for (const n of t2.docChanges)
        n.type !== 3 && e2.push(n);
      t2 = new $u(t2.query, t2.docs, t2.oldDocs, e2, t2.mutatedKeys, t2.fromCache, t2.syncStateChanged, true);
    }
    let e = false;
  ...
  Cu(t2, e) {
    if (!t2.fromCache)
      return true;
    const n = e !== "Offline";
    return (!this.options.Nu || !n) && (!t2.docs.isEmpty() || e === "Offline");
  }
  Du(t2) {
...
var Zu = class {
  ...
  applyChanges(t2, e, n) {
    ...
    const r = e ? this.Ju() : [], o = this.qu.size === 0 && this.current ? 1 : 0, u = o !== this.Uu;
    if (this.Uu = o, i.length !== 0 || u) {
      return {
        snapshot: new $u(this.query, t2.Gu, s, i, t2.mutatedKeys, o === 0, u, false),
        Yu: r
      };
    }
    return {
  ...
  tc() {
    return $u.fromInitialDocuments(this.query, this.Gu, this.mutatedKeys, this.Uu === 0);
  }
};
var tc2 = class {
  constructor(t2, e, n) {
...
async function sc2(t2, e) {
  ...
  if (r)
    ...
    s = t3.targetId, i = await ic2(n, e, s, r2 === "current");
  }
  return i;
}
async function ic2(t2, e, n, s) {
  t2.dc = (e2, n2, s2) => async function(t3, e3, n3, s3) {
    ...
    i2.$i && (i2 = await So(t3.localStore, e3.query, false).then(({ documents: t4 }) => e3.view.ju(t4, i2)));
  ...
  const i = await So(t2.localStore, e, true), r = new Zu(e, i.Hi), o = r.ju(i.documents), u = ws.createSynthesizedTargetChangeForCurrentChange(n, s && t2.onlineState !== "Offline"), c = r.applyChanges(o, t2.isPrimaryClient, u);
  gc2(t2, n, c.Yu);
...
async function rc2(t2, e) {
  ...
  if (n.isPrimaryClient) {
    ...
    n.sharedClientState.isActiveQueryTarget(s.targetId) || await Vo(n.localStore, s.targetId, false).then(() => {
      n.sharedClientState.clearQueryState(s.targetId), au(n.remoteStore, s.targetId), wc2(n, s.targetId);
    }).catch(Tt);
  } else
    wc2(n, s.targetId), await Vo(n.localStore, s.targetId, true);
}
      ...
      return n2.persistence.runTransaction("Locally write mutations", "readwrite", (t5) => {
        ...
        return n2.Gi.getEntries(t5, i).next((t6) => {
          ...
          for (const t6 of e2) {
            ...
            e3 != null && o2.push(new Kn(t6.key, e3, ve(e3.value.mapValue), kn.exists(true)));
          }
...
async function ac2(t2, e, n) {
  ...
  if (r) {
    ...
    const n2 = ls().add(r), i2 = new _s(nt.min(), /* @__PURE__ */ new Map(), new Ut(X2), t3, n2);
    await uc2(s, i2), s.oc = s.oc.remove(r), s.uc.delete(e), pc2(s);
  } else
    await Vo(s.localStore, e, false).then(() => wc2(s, e, n)).catch(Tt);
}
...
function mc2(t2, e) {
  ...
  const n = t2.oc.get(e);
  n !== null && (au(t2.remoteStore, n), t2.oc = t2.oc.remove(e), t2.uc.delete(n), pc2(t2));
}
function gc2(t2, e, n) {
  for (const s of n)
    if (s instanceof Yu)
...
async function Ac2(t2, e) {
  const n = F(t2), s = await So(n.localStore, e.query, true), i = e.view.Zu(s);
...
async function bc2(t2, e, n, s) {
  ...
  r !== null ? (n === "pending" ? await Tu(i.remoteStore) : n === "acknowledged" || n === "rejected" ? (_c(i, e, s || null), dc2(i, e), function(t3, e2) {
...
async function Pc2(t2, e) {
  const n = F(t2);
  if (xc2(n), Nc2(n), e === true && n.fc !== true) {
    const t3 = n.sharedClientState.getAllActiveQueryTargets(), e2 = await vc2(n, t3.toArray());
    n.fc = true, await Cu(n.remoteStore, true);
    for (const t4 of e2)
      cu(n.remoteStore, t4);
  } else if (e === false && n.fc !== false) {
    const t3 = [];
    let e2 = Promise.resolve();
    n.ic.forEach((s, i) => {
      n.sharedClientState.isLocalQueryTarget(i) ? t3.push(i) : e2 = e2.then(() => (wc2(n, i), Vo(n.localStore, i, true))), au(n.remoteStore, i);
...
async function vc2(t2, e, n) {
  ...
  for (const t3 of e) {
    ...
    if (n2 && n2.length !== 0) {
      ...
      e2 = await vo(s.localStore, n3), await ic2(s, Vc2(n3), t3, false);
    }
    i.push(e2);
  }
  return s.nc.Wo(r), i;
...
async function Dc2(t2, e, n, s) {
  ...
  if (r && r.length > 0)
    switch (n) {
      case "current":
      case "not-current": {
        const t3 = await Co(i.localStore, dn(r[0])), s2 = _s.createSynthesizedRemoteEventForCurrentChange(e, n === "current");
        await Ic2(i, t3, s2);
        break;
      }
      case "rejected":
        await Vo(i.localStore, e, true), wc2(i, e, s);
        break;
      default:
        k2();
    }
...
async function Cc2(t2, e, n) {
  ...
  if (s.fc) {
    for (const t3 of e) {
      ...
      await ic2(s, Vc2(e2), n2.targetId, false), cu(s.remoteStore, n2);
    }
    for (const t3 of n)
      s.ic.has(t3) && await Vo(s.localStore, t3, false).then(() => {
...
function kc2(t2, e, n) {
  ...
  (async function(t3, e2, n2) {
    try {
      ...
      return await Ic2(t3, o.Bu, void 0), await function(t4, e3) {
        const n3 = F(t4);
...
var Oc2 = class extends Mc2 {
  ...
  gc(t2) {
    const e = mo(t2.databaseInfo.databaseId, t2.databaseInfo.persistenceKey), n = this.cacheSizeBytes !== void 0 ? Er.withCacheSize(this.cacheSizeBytes) : Er.DEFAULT;
...
function ia2(t2, e) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => async function(t3, e2, n2) {
    try {
      const s = await So(t3, e2, true), i = new Zu(e2, s.Hi), r = i.ju(s.documents), o = i.applyChanges(r, false);
...
function ra2(t2, e, n = {}) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2, n2, s2, i) {
    const r = new Lc2({
      next: (n3) => {
        e2.enqueueAndForget(() => qu(t3, o)), n3.fromCache && s2.source === "server" ? i.reject(new B2($.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n3);
      },
      error: (t4) => i.reject(t4)
    }), o = new ju(n2, r, {
      includeMetadataChanges: true,
...
function wa2(t2) {
  ...
  return typeof t2 == "function" ? "a function" : k2();
}
function ma2(t2, e) {
...
var pa2 = class {
  ...
  _setSettings(t2) {
    ...
    this._settings = new ya2(t2), t2.credentials !== void 0 && (this._authCredentials = function(t3) {
      if (!t3)
        return new q2();
      switch (t3.type) {
        case "gapi":
...
function Ia2(t2, e, n, s = {}) {
  ...
  if (r.host !== "firestore.googleapis.com" && r.host !== e && x2("Host has been set in both settings() and useEmulator(), emulator host will be used"), t2._setSettings(Object.assign(Object.assign({}, r), {
    host: `${e}:${n}`,
    ssl: false
  })), s.mockUserToken) {
    let e2, n2;
...
var Aa2 = class extends Ea2 {
  ...
  get parent() {
    ...
    return t2.isEmpty() ? null : new Ta2(this.firestore, null, new ut(t2));
  }
  withConverter(t2) {
...
function Ra2(t2, e, ...n) {
  ...
  }
  {
    ...
    return _a(s), new Aa2(t2.firestore, null, s);
  }
}
function ba2(t2, e) {
  ...
  return new Ea2(t2, null, function(t3) {
    return new Xe(it.emptyPath(), t3);
  }(e));
}
function Pa2(t2, e, ...n) {
  if (t2 = getModularInstance(t2), arguments.length === 1 && (e = Y2.R()), la2("doc", "path", e), t2 instanceof pa2) {
    const s = it.fromString(e, ...n);
    return da2(s), new Ta2(t2, null, new ut(s));
  }
  {
    if (!(t2 instanceof Ta2 || t2 instanceof Aa2))
      throw new B2($.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
...
var Sa2 = class {
  constructor() {
    ...
    const t2 = Yo();
    t2 && typeof t2.addEventListener == "function" && t2.addEventListener("visibilitychange", this.jc);
  }
  get isShuttingDown() {
    return this.Lc;
  }
  ...
  enterRestrictedMode(t2) {
    if (!this.Lc) {
      ...
      const e = Yo();
      e && typeof e.removeEventListener == "function" && e.removeEventListener("visibilitychange", this.jc);
    }
  }
  enqueue(t2) {
    if (this.Wc(), this.Lc)
...
var Na2 = class extends pa2 {
  constructor(t2, e, n, s) {
    super(t2, e, n, s), this.type = "firestore", this._queue = new Sa2(), this._persistenceKey = (s == null ? void 0 : s.name) || "[DEFAULT]";
  }
  _terminate() {
...
function $a2(t2, e) {
  ...
  return La2(n, i, new Oc2(i, s.cacheSizeBytes, e == null ? void 0 : e.forceOwnership));
}
function Ba2(t2) {
  za2(t2 = ma2(t2, Na2));
...
var eh = class {
  ...
  toMutation(t2, e) {
    return this.fieldMask !== null ? new Kn(t2, this.data, this.fieldMask, e, this.fieldTransforms) : new qn(t2, this.data, e, this.fieldTransforms);
  }
};
var nh = class {
  constructor(t2, e, n) {
...
var ih = class {
  constructor(t2, e, n, s, i, r) {
    this.settings = t2, this.databaseId = e, this.It = n, this.ignoreUndefinedProperties = s, i === void 0 && this.ea(), this.fieldTransforms = i || [], this.fieldMask = r || [];
  }
  get path() {
  ...
  ia(t2) {
    var e;
    const n = (e = this.path) === null || e === void 0 ? void 0 : e.child(t2), s = this.sa({
      path: n,
      ra: false
    });
    return s.oa(t2), s;
...
var ch = class extends Xa2 {
  _toFieldTransform(t2) {
    if (t2.na !== 2)
      throw t2.na === 1 ? t2.aa(`${this._methodName}() can only appear at the top level of your update data`) : t2.aa(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var lh = class extends Xa2 {
  ...
  _toFieldTransform(t2) {
    const e = ah(this, t2, true), n = this.da.map((t3) => gh(t3, e)), s = new Rn(n);
...
var fh = class extends Xa2 {
  ...
  _toFieldTransform(t2) {
    const e = ah(this, t2, true), n = this.da.map((t3) => gh(t3, e)), s = new Pn(n);
    return new Cn(t2.path, s);
  }
  isEqual(t2) {
    return this === t2;
...
function gh(t2, e) {
  if (ph(t2 = getModularInstance(t2)))
...
function ph(t2) {
  return !(typeof t2 != "object" || t2 === null || t2 instanceof Array || t2 instanceof Date || t2 instanceof et || t2 instanceof Za || t2 instanceof Ya2 || t2 instanceof Ta2 || t2 instanceof Xa2);
}
function Ih(t2, e, n) {
  if (!ph(n) || !function(t3) {
    ...
    const s = wa2(n);
    throw s === "an object" ? e.aa(t2 + " a custom object") : e.aa(t2 + " " + s);
  }
}
function Th(t2, e, n) {
  ...
  if (typeof e == "string")
    return Ah(t2, e);
  throw Rh("Field path arguments must be of type string or ", t2, false, void 0, n);
}
var Eh = new RegExp("[~\\*/\\[\\]]");
function Ah(t2, e, n) {
  if (e.search(Eh) >= 0)
    throw Rh(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t2, false, void 0, n);
  try {
    return new Ha(...e.split("."))._internalPath;
  } catch (s) {
    throw Rh(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t2, false, void 0, n);
  }
}
...
var Ph = class {
  ...
  data() {
    if (this._document) {
      if (this._converter) {
        const t2 = new vh(this._firestore, this._userDataWriter, this._key, this._document, null);
...
function Vh(t2, e) {
  return typeof e == "string" ? Ah(t2, e) : e instanceof Ha ? e._internalPath : e._delegate._internalPath;
}
var Sh = class {
  constructor(t2, e) {
...
var Dh = class extends Ph {
  ...
  data(t2 = {}) {
    if (this._document) {
      if (this._converter) {
        const e = new Ch(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, null);
...
function kh(t2, e) {
  return t2 instanceof Dh && e instanceof Dh ? t2._firestore === e._firestore && t2._key.isEqual(e._key) && (t2._document === null ? e._document === null : t2._document.isEqual(e._document)) && t2._converter === e._converter : t2 instanceof xh && e instanceof xh && (t2._firestore === e._firestore && Va2(t2.query, e.query) && t2.metadata.isEqual(e.metadata) && t2._snapshot.isEqual(e._snapshot));
}
function Mh(t2) {
  ...
  _apply(t2) {
    const e = oh(t2.firestore), n = function(t3, e2, n2, s, i, r, o) {
      ...
      if (i.isKeyField()) {
        ...
        r !== "in" && r !== "not-in" && r !== "array-contains-any" || Zh(o, r), u = mh(n2, e2, o, r === "in" || r === "not-in");
...
function jh(...t2) {
  return new Qh("startAt", t2, true);
}
function Wh(...t2) {
  return new Qh("startAfter", t2, false);
}
...
function Hh(...t2) {
  return new zh("endBefore", t2, false);
}
function Jh(...t2) {
...
var rl = class {
  ...
  set(t2, e, n) {
    ...
    const s = ol(t2, this._firestore), i = sl(s.converter, e, n), r = uh(this._dataReader, "WriteBatch.set", s._key, i, s.converter !== null, n);
  ...
  update(t2, e, n, ...s) {
    ...
    let r;
    return r = typeof (e = getModularInstance(e)) == "string" || e instanceof Ha ? wh(this._dataReader, "WriteBatch.update", i._key, e, n, s) : _h(this._dataReader, "WriteBatch.update", i._key, e), this._mutations.push(r.toMutation(i._key, kn.exists(true))), this;
  }
  delete(t2) {
    this._verifyNotCommitted();
...
function al(t2) {
  ...
  return na2(n, t2._key).then((n2) => new Dh(e, s, t2._key, n2, new Sh(n2 !== null && n2.hasLocalMutations, true), t2.converter));
}
function hl(t2) {
  t2 = ma2(t2, Ta2);
  const e = ma2(t2.firestore, Na2);
...
function _l(t2, e, n) {
  ...
  return Il(s, [uh(oh(s), "setDoc", t2._key, i, t2.converter !== null, n).toMutation(t2._key, kn.none())]);
}
function wl(t2, e, n, ...s) {
  t2 = ma2(t2, Ta2);
  const i = ma2(t2.firestore, Na2), r = oh(i);
  let o;
  o = typeof (e = getModularInstance(e)) == "string" || e instanceof Ha ? wh(r, "updateDoc", t2._key, e, n, s) : _h(r, "updateDoc", t2._key, e);
...
function gl(t2, e) {
  ...
  return Il(n, [uh(oh(t2.firestore), "addDoc", s._key, i, t2.converter !== null, {}).toMutation(s._key, kn.exists(false))]).then(() => s);
}
function yl(t2, ...e) {
  var n, s, i;
  ...
  typeof e[o] != "object" || Da(e[o]) || (r = e[o], o++);
  const u = {
...
var El = class extends class {
  ...
  set(t2, e, n) {
    const s = ol(t2, this._firestore), i = sl(s.converter, e, n), r = uh(this._dataReader, "Transaction.set", s._key, i, s.converter !== null, n);
    return this._transaction.set(s._key, r), this;
  }
  update(t2, e, n, ...s) {
    const i = ol(t2, this._firestore);
    let r;
    return r = typeof (e = getModularInstance(e)) == "string" || e instanceof Ha ? wh(this._dataReader, "Transaction.update", i._key, e, n, s) : _h(this._dataReader, "Transaction.update", i._key, e), this._transaction.update(i._key, r), this;
  }
  delete(t2) {
    const e = ol(t2, this._firestore);
  ...
  get(t2) {
    ...
    return super.get(t2).then((t3) => new Dh(this._firestore, n, e._key, t3._document, new Sh(false, false), e.converter));
  }
};
function Al(t2, e, n) {
  t2 = ma2(t2, Na2);
...
function validateSetOptions(methodName, options) {
  ...
  if (options.mergeFields !== void 0 && options.merge !== void 0) {
    throw new B2("invalid-argument", `Invalid options passed to function ${methodName}(): You cannot specify both "merge" and "mergeFields".`);
  }
  return options;
}
function assertUint8ArrayAvailable() {
  if (typeof Uint8Array === "undefined") {
    throw new B2("unimplemented", "Uint8Arrays are not available in this environment.");
  }
}
function assertBase64Available() {
  if (!Qt()) {
    throw new B2("unimplemented", "Blobs are unavailable in Firestore in this environment.");
  }
}
var Blob = class {
  ...
  static fromBase64String(base64) {
    ...
    return new Blob(Ya2.fromBase64String(base64));
  }
  static fromUint8Array(array) {
    assertUint8ArrayAvailable();
    return new Blob(Ya2.fromUint8Array(array));
  }
  toBase64() {
    assertBase64Available();
...
var IndexedDbPersistenceProvider = class {
  enableIndexedDbPersistence(firestore, forceOwnership) {
    return $a2(firestore._delegate, { forceOwnership });
  }
  enableMultiTabIndexedDbPersistence(firestore) {
    return Ba2(firestore._delegate);
  }
  clearIndexedDbPersistence(firestore) {
    return Ua2(firestore._delegate);
  }
};
var Firestore = class {
  constructor(databaseIdOrApp, _delegate, _persistenceProvider) {
    ...
    if (!(databaseIdOrApp instanceof ee)) {
  ...
  settings(settingsLiteral) {
    ...
    if (!settingsLiteral.merge && currentSettings.host !== settingsLiteral.host) {
      x2("You are overriding the original host. If you did not intend to override your settings, use {merge: true}.");
    }
  ...
  useEmulator(host, port, options = {}) {
    Ia2(this._delegate, host, port, options);
  }
  enableNetwork() {
    return Ka(this._delegate);
  }
  disableNetwork() {
    return Ga(this._delegate);
  }
  enablePersistence(settings) {
    ...
    if (settings) {
      ...
      fa2("synchronizeTabs", synchronizeTabs, "experimentalForceOwningTab", experimentalForceOwningTab);
    }
  ...
  waitForPendingWrites() {
    return qa2(this._delegate);
  }
  onSnapshotsInSync(arg) {
    return pl(this._delegate, arg);
  }
  get app() {
    if (!this._appCompat) {
      throw new B2("failed-precondition", "Firestore was not initialized using the Firebase SDK. 'app' is not available");
    }
    return this._appCompat;
  }
  collection(pathString) {
    try {
      return new CollectionReference(this, Ra2(this._delegate, pathString));
    } catch (e) {
  ...
  doc(pathString) {
    try {
      return new DocumentReference(this, Pa2(this._delegate, pathString));
    } catch (e) {
  ...
  collectionGroup(collectionId) {
    try {
      return new Query(this, ba2(this._delegate, collectionId));
    } catch (e) {
      throw replaceFunctionName(e, "collectionGroup()", "Firestore.collectionGroup()");
    }
  }
  runTransaction(updateFunction) {
    return Al(this._delegate, (transaction) => updateFunction(new Transaction(this, transaction)));
  }
  batch() {
    Oa2(this._delegate);
    return new WriteBatch(new rl(this._delegate, (mutations) => Il(this._delegate, mutations)));
  }
  loadBundle(bundleData) {
    return ja2(this._delegate, bundleData);
  }
  namedQuery(name2) {
    return Wa2(this._delegate, name2).then((expQuery) => {
      if (!expQuery) {
        return null;
      }
...
var UserDataWriter = class extends nl {
  constructor(firestore) {
    super();
    this.firestore = firestore;
  }
  convertBytes(bytes) {
    return new Blob(new Ya2(bytes));
  }
...
var Transaction = class {
  ...
  get(documentRef) {
    ...
    return this._delegate.get(ref).then((result) => new DocumentSnapshot(this._firestore, new Dh(this._firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, ref.converter)));
  }
...
var FirestoreDataConverter = class {
  ...
  fromFirestore(snapshot, options) {
    const expSnapshot = new Ch(this._firestore._delegate, this._userDataWriter, snapshot._key, snapshot._document, snapshot.metadata, null);
...
var DocumentReference = class {
  ...
  static forPath(path, firestore, converter) {
    if (path.length % 2 !== 0) {
      throw new B2("invalid-argument", `Invalid document reference. Document references must have an even number of segments, but ${path.canonicalString()} has ${path.length}`);
    }
    return new DocumentReference(firestore, new Ta2(firestore._delegate, converter, new ut(path)));
  }
  static forKey(key, firestore, converter) {
    return new DocumentReference(firestore, new Ta2(firestore._delegate, converter, key));
  }
  get id() {
  ...
  collection(pathString) {
    try {
      return new CollectionReference(this.firestore, Ra2(this._delegate, pathString));
    } catch (e) {
  ...
  isEqual(other) {
    ...
    if (!(other instanceof Ta2)) {
      return false;
    }
    return va2(this._delegate, other);
  }
  set(value, options) {
    options = validateSetOptions("DocumentReference.set", options);
    try {
      if (options) {
        return _l(this._delegate, value, options);
      } else {
        return _l(this._delegate, value);
      }
    } catch (e) {
  ...
  update(fieldOrUpdateData, value, ...moreFieldsAndValues) {
    try {
      if (arguments.length === 1) {
        return wl(this._delegate, fieldOrUpdateData);
      } else {
        return wl(this._delegate, fieldOrUpdateData, value, ...moreFieldsAndValues);
      }
    } catch (e) {
  ...
  delete() {
    return ml(this._delegate);
  }
  onSnapshot(...args) {
    const options = extractSnapshotOptions(args);
    const observer = wrapObserver(args, (result) => new DocumentSnapshot(this.firestore, new Dh(this.firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, this._delegate.converter)));
    return yl(this._delegate, options, observer);
  }
  get(options) {
    let snap;
    if ((options === null || options === void 0 ? void 0 : options.source) === "cache") {
      ...
      snap = hl(this._delegate);
    } else {
      snap = ul(this._delegate);
    }
    return snap.then((result) => new DocumentSnapshot(this.firestore, new Dh(this.firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, this._delegate.converter)));
  }
...
var DocumentSnapshot = class {
  ...
  isEqual(other) {
    return kh(this._delegate, other._delegate);
  }
};
var QueryDocumentSnapshot = class extends DocumentSnapshot {
  data(options) {
    const data = this._delegate.data(options);
    O2(data !== void 0, "Document in a QueryDocumentSnapshot should exist");
    return data;
  }
};
var Query = class {
  ...
  where(fieldPath, opStr, value) {
    try {
      return new Query(this.firestore, Fh(this._delegate, Bh(fieldPath, opStr, value)));
    } catch (e) {
  ...
  orderBy(fieldPath, directionStr) {
    try {
      return new Query(this.firestore, Fh(this._delegate, Uh(fieldPath, directionStr)));
    } catch (e) {
      throw replaceFunctionName(e, /(orderBy|where)\(\)/, "Query.$1()");
    }
  }
  limit(n) {
    try {
      return new Query(this.firestore, Fh(this._delegate, Kh(n)));
    } catch (e) {
  ...
  limitToLast(n) {
    try {
      return new Query(this.firestore, Fh(this._delegate, Gh(n)));
    } catch (e) {
  ...
  startAt(...args) {
    try {
      return new Query(this.firestore, Fh(this._delegate, jh(...args)));
    } catch (e) {
  ...
  startAfter(...args) {
    try {
      return new Query(this.firestore, Fh(this._delegate, Wh(...args)));
    } catch (e) {
  ...
  endBefore(...args) {
    try {
      return new Query(this.firestore, Fh(this._delegate, Hh(...args)));
    } catch (e) {
  ...
  isEqual(other) {
    return Va2(this._delegate, other._delegate);
  }
  get(options) {
    let query;
    if ((options === null || options === void 0 ? void 0 : options.source) === "cache") {
      query = fl(this._delegate);
    } else if ((options === null || options === void 0 ? void 0 : options.source) === "server") {
      query = dl(this._delegate);
    } else {
      query = ll(this._delegate);
    }
    return query.then((result) => new QuerySnapshot(this.firestore, new xh(this.firestore._delegate, this._userDataWriter, this._delegate, result._snapshot)));
  }
  onSnapshot(...args) {
    const options = extractSnapshotOptions(args);
    const observer = wrapObserver(args, (snap) => new QuerySnapshot(this.firestore, new xh(this.firestore._delegate, this._userDataWriter, this._delegate, snap._snapshot)));
    return yl(this._delegate, options, observer);
  }
  withConverter(converter) {
...
var CollectionReference = class extends Query {
  ...
  doc(documentPath) {
    try {
      if (documentPath === void 0) {
        return new DocumentReference(this.firestore, Pa2(this._delegate));
      } else {
        return new DocumentReference(this.firestore, Pa2(this._delegate, documentPath));
      }
    } catch (e) {
  ...
  add(data) {
    return gl(this._delegate, data).then((docRef) => new DocumentReference(this.firestore, docRef));
  }
  isEqual(other) {
    return va2(this._delegate, other._delegate);
  }
...
function castReference(documentRef) {
  return ma2(documentRef, Ta2);
}
var FieldPath = class {
  constructor(...fieldNames) {
    this._delegate = new Ha(...fieldNames);
  }
  static documentId() {
    return new FieldPath(ot.keyField().canonicalString());
  }
  isEqual(other) {
    other = getModularInstance(other);
...
var FieldValue = class {
  ...
  static arrayUnion(...elements) {
    const delegate = Pl(...elements);
    delegate._methodName = "FieldValue.arrayUnion";
    return new FieldValue(delegate);
  }
  static arrayRemove(...elements) {
    const delegate = vl(...elements);
